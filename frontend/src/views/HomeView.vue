                ...
                <div class="content__dough">
                    ...
                    <div class="sheet">
                        ...
                        <div class="sheet__content dough">
                            <label v-for="doughType in doughItems" :key="doughType.id"
                                class="dough__input dough__input--light">
                                <input type="radio" name="dought" :value="doughType.value" class="visually-hidden"
                                    checked>
                ...
                <div class="content__diameter">
                    <div class="sheet">
                        ...
                        <div class="sheet__content diameter">
                            <label class="diameter__input" :class="`diameter__input--${sizeType.value}`"
                                v-for="sizeType in sizeItems" :key="sizeType.id">
                    ...
                    <div class="sheet">
                        ...
                        <div class="sheet__content ingredients">
                            ...
                            <div class="ingredients__sauce">
                                ...
                                <label v-for="sauceType in sauceItems" :key="sauceType.id"
...
import {normalizeDough, normalizeSize, normalizeIngredients, normalizeSauces} from "@/common/helpers/normalize.js";
